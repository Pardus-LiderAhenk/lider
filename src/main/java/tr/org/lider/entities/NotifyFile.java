...
public class NotifyFile implements Serializable {
	...
	@Id
	@GeneratedValue
	@Column(name = "NOTIFY_FILE_ID", unique = true, nullable = false)
	private Long id;
	...
	public NotifyFile(Long id, ScriptType scriptType, String label, Integer time, String contents, Date createDate, Date modifyDate) {
		this.id = id;
		this.label = label;
		this.time = time;
