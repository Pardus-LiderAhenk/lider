...
public class ScriptTemp implements Serializable {
	...
	public ScriptTemp(Long id, ScriptType scriptType, String label, String contents, Date createDate, Date modifyDate) {
		this.id = id;
