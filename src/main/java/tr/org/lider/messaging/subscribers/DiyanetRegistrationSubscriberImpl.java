...
@Component
@ConditionalOnProperty(name = "registrationSubscriber.class", havingValue = "diyanet")
public class DiyanetRegistrationSubscriberImpl implements IRegistrationSubscriber {

	private static Logger logger = LoggerFactory.getLogger(DiyanetRegistrationSubscriberImpl.class);
