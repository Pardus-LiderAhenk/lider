...
//					agents = agentRepository.findByMacAddressesContainingAndCreateDateGreaterThanAndCreateDateLessThan(text.get(), pageable, null, null);
//				} else if(status.equals("online")) {
...
//	}
	...
	public Page<AgentImpl> findAllAgentsFiltered(int pageNumber, int pageSize, String status,
		...
		Page<AgentImpl> listOfAgentsCB = agentInfoCB.filterAgents(pageNumber, pageSize, status, field, text, registrationStartDate, registrationEndDate);
