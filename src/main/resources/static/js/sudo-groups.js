/**
 * When page loading getting sudo groups from LDAP and fill out on the treegrid that used jqxTreeGrid api..
 * M. Edip YILDIZ
 * 
 */
			 ...
			 $("#treeGridUser").jqxTreeGrid(
			 {
			     ...
			     icons: function (rowKey, dataRow) {
			    	    ...
			    	    if(dataRow.type == "ORGANIZATIONAL_UNIT"){
			    	        return "img/entry_default.gif";
			    	    }
			    	    else return "img/batch.gif";
			    	},
			     ready: function () {
			    	 
			     },
			     columns: [
			       { text: "Yetki Grupları", align: "center", dataField: "name", width: 320 }
			     ]
			 });
